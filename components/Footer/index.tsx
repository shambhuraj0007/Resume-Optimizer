        ...
        <div className="flex flex-col sm:flex-row items-center sm:justify-between gap-3 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6">
            <p className="text-xs sm:text-sm">
              © {currentYear} ShortlistAI.cv A brand of MindMach Technologies Pvt Ltd. All rights reserved
            </p>

            <div className="flex items-center gap-4">
              <Link
                href="/privacy"
                className="relative text-muted-foreground hover:text-foreground transition-colors text-xs sm:text-sm group"
              >
                Privacy
