...
export default function SalaryPage({ post }: Props) {
    return (
        <main className="relative min-h-screen bg-gray-950 text-gray-50 overflow-hidden selection:bg-indigo-500/30">
            ...
            <div className="absolute top-0 right-1/4 w-[600px] h-[400px] opacity-10 pointer-events-none">
                <div className="absolute inset-0 bg-gradient-to-bl from-emerald-500 via-indigo-500 to-transparent blur-[100px] rounded-full mix-blend-screen" />
            </div>
