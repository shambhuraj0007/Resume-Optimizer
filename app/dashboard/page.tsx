      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-6 py-6 sm:py-8 lg:py-10 max-w-7xl">
        ...
        <div className="mb-6 sm:mb-8 lg:mb-10">
          <Suspense fallback={
            <Card className="border-2">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl text-foreground">Analysis History</CardTitle>
                <CardDescription className="text-xs sm:text-sm">
        ...
        <div className="mb-6 sm:mb-8 lg:mb-10">
          <Suspense fallback={
            <Card className="border-2">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl text-foreground">Payment History</CardTitle>
                <CardDescription className="text-xs sm:text-sm">
