            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8 md:p-12 transition-colors duration-300">
              ...
              <section id="content" className="mb-12 scroll-mt-24">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-3xl font-bold text-foreground">Use of Uploaded Content</h2>
                </div>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <section id="payments" className="mb-12 scroll-mt-24">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">Refund and Cancellation policy </h3>
              ...
              <section id="shipping" className="mb-12 scroll-mt-24">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-3xl font-bold text-foreground">Shipping & Delivery Policy</h2>
                </div>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <section id="intellectual" className="mb-12 scroll-mt-24">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-3xl font-bold text-foreground">Intellectual Property</h2>
                </div>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <section id="termination" className="mb-12 scroll-mt-24">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-3xl font-bold text-foreground">Termination</h2>
                </div>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <section id="governing" className="mb-12 scroll-mt-24">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-3xl font-bold text-foreground">Governing Law</h2>
                </div>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                <p className="text-gray-700 pt-2 dark:text-gray-300 leading-relaxed">
                  ShortlistAI.cv is a product built and operated by MindMach Technologies Private Limited.
                </p>
              </section>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Email: <a href="mailto:hello@shortlistAI.cv"
                        ...
                        [hello@shortlistAI.cv](mailto:hello@shortlistAI.cv)
                      </a>
                    </p>
                  </div>
                </div>
