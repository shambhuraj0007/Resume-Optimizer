                  ...
                  {tableOfContents.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center gap-2 px-3 py-2 text-sm rounded-md transition-all ${activeSection === item.id
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8 md:p-12 transition-colors duration-300">
              ...
              <section id="information-collect" className="mb-12 scroll-mt-24">
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="text-xl font-semibold text-foreground mb-3">2.1 User-Provided Data</h3>
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-foreground mb-3">2.2 Usage Data</h3>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-foreground mb-3">2.4 Third-Party Tools</h3>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              <section id="advertising" className="mb-12 scroll-mt-24">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-3xl font-bold text-foreground">Advertising & Monetisation</h2>
                </div>
              ...
              <section id="deletion" className="mb-12 scroll-mt-24">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-3xl font-bold text-foreground">Data Deletion & User Rights</h2>
                </div>
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                  To exercise these rights, email us at: <a href="mailto:hello@shortlistAI.cv"
                    className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 font-medium underline">hello@shortlistAI.cv</a>
                </p>
              ...
              <section id="sharing" className="mb-12 scroll-mt-24">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-3xl font-bold text-foreground">Sharing of Information</h2>
                </div>
              ...
              <section id="contact" className="scroll-mt-24">
                ...
                <div className="bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 rounded-lg p-6 border border-indigo-100 dark:border-indigo-800">
                  ...
                  <div className="space-y-2">
                    <p className="text-foreground font-semibold">Mindmach Technologies</p>
                    <p className="text-gray-700 dark:text-gray-300">
                      Email: <a href="mailto:hello@shortlistAI.cv"
                        className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 font-medium underline">
                        hello@shortlistAI.cv
                      </a>
                    </p>
                  </div>
                </div>
