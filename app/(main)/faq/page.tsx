...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: (
      <>
        Absolutely. Over <strong>75% of resumes are rejected</strong> before human review at companies with over 50 employees. An <strong>ATS-friendly resume</strong> ensures your qualifications are detected properly. <Link href="https://shortlistai.cv/" className="text-indigo-500 dark:text-indigo-300 underline">ShortlistAI</Link> shows what keywords and formatting changes you need.
      </>
    ),
  },
  {
